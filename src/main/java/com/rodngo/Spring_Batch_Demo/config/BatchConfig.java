...
public class BatchConfig {
    ...
    public RepositoryItemWriter<StudentUpdate> writer() {
        RepositoryItemWriter<StudentUpdate> writer = new RepositoryItemWriter<>();
        writer.setRepository(studentUpdateRepository);
    ...
    public Step step1() {
        return new StepBuilder("csvImport", jobRepository)
                .<Student, StudentUpdate>chunk(1000, platformTransactionManager)
                .reader(reader())
                .processor(processor())
                .writer(writer())
